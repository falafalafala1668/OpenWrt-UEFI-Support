...
Openwrt official has changed the image generation by the way, If your source Commit ID is older than( include) ``kernel: connmark set - dscpmark fix the build on 5.4 (e6e1e12dc3230bdadf74485dbf47beb52570920c)``, please use master-e6e1e12 tag.
