# OpenWrt UEFI Support (Unofficial Support,For master commit e6e1e12dc3230bdadf74485dbf47beb52570920c)

**IMPORTANT**

Openwrt official has changed the image generated by the way, if your source HEAD is ``kernel: connmark set - dscpmark fix the build on 5.4 (e6e1e12dc3230bdadf74485dbf47beb52570920c)``, please use this tag.
